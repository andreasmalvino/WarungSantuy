            ...
            <div id="myModal" class="modal">
                <div class="modal-content">
                    ...
                    <form id="modalForm1" onsubmit="submitModal(event)">
                        ...
                        <input type="text" name="currentUsername" id="currentUsername" placeholder="Username">
                        <div class="modal-buttons">
            ...
            <div id="myModal3" class="modal">
                <div class="modal-content">
                    ...
                    <form id="modalForm3" method="post" action="change_password.php" onsubmit="return validateForm()">
                        ...
                        <p>Kata Sandi Baru</p>
                        <input type="password" name="newPassword" id="newPassword" placeholder="Katasandi">
                        <input type="password" name="confirmPassword" id="confirmPassword" placeholder="Konfirmasi katasandi">
